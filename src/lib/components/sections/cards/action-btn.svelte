...
<Button
	...
	onclick={downloadVCF}
	class={cn(
		` rounded-lg border-[0.3px] border-white bg-white/60 py-6 text-base font-medium text-black backdrop-blur-lg hover:bg-white dark:border-black dark:bg-white/20 dark:text-white hover:dark:bg-white/10 lg:bg-[#F3F3F3] lg:backdrop-blur-0`,
		className
	)}
>
	{#if loading}
